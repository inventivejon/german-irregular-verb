...
db.execute('CREATE TABLE IF NOT EXISTS UnregelmäßigeVerben (id INTEGER PRIMARY KEY AUTOINCREMENT, Infinitiv VARCHAR(250), Typ VARCHAR(250), Wortform VARCHAR(250))')
...
r = requests.get('https://de.m.wiktionary.org/wiki/Verzeichnis:Deutsch/Unregelm%C3%A4%C3%9Fige_Verben')
r.encoding = 'UTF-8'
...
resultsWithoutLink = [(re.search("\">(.*?)</a></li>",i).group(1), None) for i in resultsWithoutLink if re.search("\">(.*?)</a></li>",i) is not None]

# Get all entries with link, strip all None entries
resultsWithLink = [i for i in list(map(getAllWithLink, x)) if i is not None]
# Strip all irrelevant code
resultsWithLink = [(re.search("\">(.*?)</a",i).group(1),re.search("href=\"(.*?)\"",i).group(1)) for i in resultsWithLink if re.search("\">(.*?)</a",i) is not None and re.search("href=\"(.*?)\"",i) is not None]
...
for singleVerb in mergedResults:
    ...
    db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'Infinitiv', newEntry['Infinitiv']))
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'Praesens1PersonSingular', newEntry['Praesens1PersonSingular']))
                    except:
                        newEntry['Praesens1PersonSingular'] = None
                    
                    try:
                        newEntry['Praesens2PersonSingular'] = re.search("Präsens.*?>du<.*?title.*?>(.*?)</a>", verbTable).group(1)
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'Praesens2PersonSingular', newEntry['Praesens2PersonSingular']))
                    except:
                    ...
                    try:
                        ...
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'Praesens3PersonSingular', newEntry['Praesens3PersonSingular']))
                    except:
                    ...
                    try:
                        ...
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'Praeteritum1PersonSingular', newEntry['Praeteritum1PersonSingular']))
                    except:
                    ...
                    try:
                        ...
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'Praeteritum2PersonSingular', newEntry['Praeteritum2PersonSingular']))
                    except:
                    ...
                    try:
                        ...
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'Praeteritum3PersonSingular', newEntry['Praeteritum3PersonSingular']))
                    except:
                    ...
                    try:
                        ...
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'KonjunktivII1PersonSingular', newEntry['KonjunktivII1PersonSingular']))
                    except:
                    ...
                    try:
                        ...
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'KonjunktivII2PersonSingular', newEntry['KonjunktivII2PersonSingular']))
                    except:
                    ...
                    try:
                        ...
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'KonjunktivII3PersonSingular', newEntry['KonjunktivII3PersonSingular']))
                    except:
                    ...
                    try:
                        ...
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'ImperativSingular', newEntry['ImperativSingular']))
                    except:
                        newEntry['ImperativSingular'] = None
                    
                    try:
                        newEntry['ImperativPlural'] = re.search("Imperativ.*?>Plural<.*?title.*?>(.*?)</a>", verbTable).group(1)
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'ImperativPlural', newEntry['ImperativPlural']))
                    except:
                        newEntry['ImperativPlural'] = None
                    
                    try:
                        newEntry['PerfektPartizip2'] = re.search("Perfekt.*?>Hilfsverb<.*?title.*?>(.*?)</a>.*?title.*?>(.*?)</a>", verbTable).group(1)
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'PerfektPartizip2', newEntry['PerfektPartizip2']))
                    except:
                        newEntry['PerfektPartizip2'] = None
                    
                    try:
                        newEntry['PerfektHilfsverb'] = re.search("Perfekt.*?>Hilfsverb<.*?title.*?>(.*?)</a>.*?title.*?>(.*?)</a>", verbTable).group(2)
                        db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(newEntry['Infinitiv'], 'PerfektHilfsverb', newEntry['PerfektHilfsverb']))
                    except:
