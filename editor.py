...
window.title("Viewer DB Unregelmäßige Verben")
...
def UpdateOrInsertIntoDB(valInfinitiv, valTyp, valWortform):
    if valWortform is not None and valWortform.isspace() is False:
        ...
        if db_result is not None and len(db_result)>0:
            print('UPDATE UnregelmäßigeVerben SET Infinitiv=\'{}\', Typ=\'{}\', Wortform=\'{}\' WHERE id={}'.format(valInfinitiv, valTyp, valWortform, db_result[0]))
            db.execute('UPDATE UnregelmäßigeVerben SET Infinitiv=\'{}\', Typ=\'{}\', Wortform=\'{}\' WHERE id={}'.format(valInfinitiv, valTyp, valWortform, db_result[0]))
        else:
            print('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(valInfinitiv, valTyp, valWortform))
            db.execute('INSERT INTO UnregelmäßigeVerben VALUES(NULL,\'{}\',\'{}\',\'{}\')'.format(valInfinitiv, valTyp, valWortform))
        db.commit()
